...
;(function ( $, window, undefined ) {
  ...
  Stalker.prototype.init = function()
  {
    ...
    this._baseWidth = this.jElement.outerWidth();
    ...
    this.placeholder = this.styleClone(this.jElement).css('height', this.jElement.outerHeight());
    ...
    function handleEvent()
    {
      ...
      {
        me._baseWidth = me.jElement.outerWidth();
